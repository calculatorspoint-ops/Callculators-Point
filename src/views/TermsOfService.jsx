      ...
      <div className="page-wrap" style={{ maxWidth:840 }}>
        ...
        <div style={{ padding:"16px 18px", background:"var(--brand-l)", border:"1px solid var(--brand-ll)", borderRadius:"var(--r-xl)", marginBottom:32 }}>
          <p style={{ fontSize:13, color:"var(--brand)", fontWeight:600, lineHeight:1.7 }}>
            ...
            <Link href="/privacy-policy" style={{ color:"var(--brand)", fontWeight:700 }}>Privacy Policy</Link>. 
        ...
        <S id="privacy" n="9" title="Privacy">
          <P>Your use of Calculators Point is also governed by our <Link href="/privacy-policy" style={{ color:"var(--brand)" }}>Privacy Policy</Link>, which is incorporated into these Terms by reference. The Privacy Policy explains how we collect, use, and protect your information.</P>
        </S>
