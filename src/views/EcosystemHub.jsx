    ...
    <div style={{
      ...
      {calcs.map((c, i) => (
        <div key={c.id} style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <Link href={`/calculator/${c.slug}`} style={{
...
export default function EcosystemHub({ ecosystemId }) {
  ...
  return (
    <>
      {/* SEO metadata handled by generateMetadata in app/ecosystem/[ecosystemId]/page.tsx */}
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 24, flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 280 }}>
              ...
              {popularInEco.length > 0 && (
                <Link href={`/calculator/${popularInEco[0].slug}`} className="btn-primary" style={{ gap: 8 }}>
