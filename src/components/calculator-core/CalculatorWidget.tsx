...
const Utility = {
  ...
  PeriodForm: lazy(() => import('./forms/PeriodForm').then((m: any) => ({ default: m.PeriodForm }))),
...
export const FORMS: FormsRegistry = {
  ...
  "time-zone-converter":               lazy(() => import('./forms/UtilityForms').then((m: any) => ({ default: m.TimeZoneForm }))),
  ...
  // ── Math (new) ────────────────────────────────────────────────────
  "lcm-gcf-calculator":                lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.LCMGCFForm }))),
  "factor-calculator":                 lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.FactorForm }))),
  "exponent-calculator":               lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.ExponentForm }))),
  "root-calculator":                   lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.RootForm }))),
  "triangle-calculator":               lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.TriangleForm }))),
  "circle-calculator":                 lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.CircleForm }))),
  "volume-calculator":                 lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.VolumeForm }))),
  "surface-area-calculator":           lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.SurfaceAreaForm }))),
  "z-score-calculator":                lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.ZScoreForm }))),
  "confidence-interval-calculator":    lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.ConfidenceIntervalForm }))),
  "sample-size-calculator":            lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.SampleSizeForm }))),
  "permutation-combination-calculator": lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.PermCombForm }))),
  "probability-calculator":            lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.ProbabilityForm }))),
  "binary-calculator":                 lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.BinaryForm }))),
  "number-sequence-calculator":        lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.NumberSequenceForm }))),
  "average-calculator":                lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.AverageForm }))),
  "matrix-calculator":                 lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.MatrixForm }))),
  "linear-equation-solver":            lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.LinearEquationForm }))),
  "random-number-generator-adv":       lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.RandomNumberForm }))),
  "percent-error-calculator":          lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.PercentErrorForm }))),
  "distance-calculator":               lazy(() => import('./forms/MathForms').then((m: any) => ({ default: m.DistanceForm }))),

  // ── Health (new) ──────────────────────────────────────────────────
  "bsa-calculator":                    lazy(() => import('./forms/HealthForms').then((m: any) => ({ default: m.BSAForm }))),
  "bac-calculator":                    lazy(() => import('./forms/HealthForms').then((m: any) => ({ default: m.BACForm }))),
  "lean-body-mass-calculator":         lazy(() => import('./forms/HealthForms').then((m: any) => ({ default: m.LeanBodyMassForm }))),
  "protein-calculator":                lazy(() => import('./forms/HealthForms').then((m: any) => ({ default: m.ProteinForm }))),
  "healthy-weight-calculator":         lazy(() => import('./forms/HealthForms').then((m: any) => ({ default: m.HealthyWeightForm }))),
  "fat-intake-calculator":             lazy(() => import('./forms/HealthForms').then((m: any) => ({ default: m.FatIntakeForm }))),
  "army-body-fat-calculator":          lazy(() => import('./forms/HealthForms').then((m: any) => ({ default: m.ArmyBodyFatForm }))),
