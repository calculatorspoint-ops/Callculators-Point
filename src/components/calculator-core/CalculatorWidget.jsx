...
const Finance = {
  ...
  // New Finance Forms
  MortgagePayoffForm: lazy(() => import("./forms/ExtraFinanceForms.jsx").then(m => ({ default: m.MortgagePayoffForm }))),
  ...
  APRForm: lazy(() => import("./forms/ExtraFinanceForms.jsx").then(m => ({ default: m.APRForm }))),
  ...
  CommissionForm: lazy(() => import("./forms/ExtraFinanceForms.jsx").then(m => ({ default: m.CommissionForm }))),
  DepreciationForm: lazy(() => import("./forms/FinanceFormsNew.jsx").then(m => ({ default: m.DepreciationForm }))),
  BudgetForm: lazy(() => import("./forms/ExtraFinanceForms.jsx").then(m => ({ default: m.BudgetForm }))),
  PresentValueForm: lazy(() => import("./forms/ExtraFinanceForms.jsx").then(m => ({ default: m.PresentValueForm }))),
  IRRForm: lazy(() => import("./forms/FinanceFormsNew.jsx").then(m => ({ default: m.IRRForm }))),
  DownPaymentForm: lazy(() => import("./forms/ExtraFinanceForms.jsx").then(m => ({ default: m.DownPaymentForm }))),
