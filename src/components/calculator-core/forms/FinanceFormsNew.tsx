...
export function InvestmentCalcForm() {
  ...
  return (
    <FinanceLayout
      accentClass="accent-invest"
      inputTitle="Investment Calculator"
      inputIcon="💰"
      inputContent={<>
        <Presets items={[
