...
import { CATEGORIES, BY_CATEGORY, POPULAR, ALL_CALCULATORS } from "@/data/calculatorConfigs.js";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={`Browse ${calcs.length} free ${cat.name} calculators. ${content.intro || cat.desc} Instant, accurate, and 100% private.`} />
        <meta name="keywords" content={`${cat.name.toLowerCase()}, free ${cat.name.toLowerCase()} calculators, online ${cat.name.toLowerCase()} tools`} />
        <link rel="canonical" href={`https://calculatorspoint.com/category/${cat.id}`} />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          name: `${cat.name} Calculators`,
          description: content.intro || cat.desc,
          url: `https://calculatorspoint.com/category/${cat.id}`,
          hasPart: calcs.map(c => ({
            "@type": "WebApplication",
            name: c.name,
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 20, flexWrap: "wrap" }}>
            ...
            <div style={{ flex: 1, minWidth: 240 }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                {content.ecosystemId && (
                  <Link to={`/ecosystem/${content.ecosystemId}`} className="btn-ghost" style={{ fontSize: 13 }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 20px 64px" }}>
        <div className="category-page-layout">
          ...
          <aside style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {content.ecosystemId && (
              <Link to={`/ecosystem/${content.ecosystemId}`} style={{
