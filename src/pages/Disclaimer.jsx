    ...
    <>
      ...
      <div className="page-wrap" style={{ maxWidth:840 }}>
        ...
        <div style={{ padding:"20px 22px", background:"var(--surf2)", border:"1px solid var(--border)", borderRadius:"var(--r-xl)", marginTop:8 }}>
          ...
          <P>If you believe any calculator result is inaccurate, please <Link to="/contact" style={{ color:"var(--brand)" }}>contact us</Link> with details. We are committed to maintaining accuracy and will investigate all reported issues promptly.</P>
        </div>
        ...
        <div style={{ display:"flex", gap:12, flexWrap:"wrap", marginTop:28, paddingTop:24, borderTop:"1px solid var(--border)" }}>
          ...
          <Link to="/terms-of-service" className="btn-outline">Terms of Service</Link>
          <Link to="/contact"          className="btn-primary" style={{ fontSize:13 }}>Report an Issue</Link>
        </div>
      </div>
    </>
  );
