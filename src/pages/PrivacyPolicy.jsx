        ...
        <div style={{ display:"grid", gridTemplateColumns:"220px 1fr", gap:28, alignItems:"start" }} id="pp-grid">
          ...
          <div>
            ...
            <Section id="contact-pp" title="12. Contact Us">
              <P>If you have questions, concerns, or requests regarding this Privacy Policy, please contact us via our <Link to="/contact" style={{ color:"var(--brand)" }}>Contact Page</Link>.</P>
