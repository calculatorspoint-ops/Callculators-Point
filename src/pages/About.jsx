      ...
      <div className="page-hero">
        <div style={{ position:"relative", zIndex:1 }}>
          ...
          <div style={{ display:"flex", justifyContent:"center", gap:12, flexWrap:"wrap", marginTop:24 }}>
            <Link to="/calculators" className="btn-primary" style={{ fontSize:13 }}>
              Explore Calculators
            </Link>
            <Link to="/contact" className="btn-ghost" style={{ fontSize:13 }}>
              Get in Touch
            </Link>
          </div>
        </div>
      ...
      <div className="page-wrap" style={{ maxWidth:900 }}>
        ...
        <div style={{ textAlign:"center", padding:"40px 24px", background:"linear-gradient(135deg,var(--brand),var(--brand-d))", borderRadius:"var(--r-2xl)", boxShadow:"var(--sh-brand)" }}>
          ...
          <div style={{ display:"flex", gap:12, justifyContent:"center", flexWrap:"wrap" }}>
            ...
            <Link to="/contact" style={{ padding:"10px 20px", borderRadius:"var(--r-lg)", background:"rgba(255,255,255,.15)", color:"#fff", fontWeight:600, fontSize:14, textDecoration:"none", border:"1px solid rgba(255,255,255,.2)" }}>
              Contact Us
            </Link>
          </div>
        </div>
