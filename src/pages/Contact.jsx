...
import { Mail, MessageSquare, AlertCircle, Lightbulb, Bug, HelpCircle, Send, Check } from "lucide-react";
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    // Simulate sending (replace with actual endpoint in production)
            ...
            {submitted ? (
              <div style={{ textAlign:"center", padding:"48px 32px", background:"var(--surface)", border:"1px solid var(--green-ll)", borderRadius:"var(--r-2xl)", boxShadow:"var(--sh2)" }}>
                ...
                <div style={{ display:"flex", gap:10, justifyContent:"center", flexWrap:"wrap" }}>
                  ...
                  <Link to="/calculators" className="btn-primary" style={{ fontSize:13 }}>Browse Calculators</Link>
                </div>
              </div>
            ) : (
                ...
                <form onSubmit={handleSubmit} noValidate style={{ marginTop:20 }}>
                  ...
                  <div style={{ marginBottom:20 }}>
                    ...
                    <textarea value={form.message} onChange={e=>update("message",e.target.value)}
                      placeholder="Please describe your issue, suggestion, or question in detail. For bug reports, include the calculator name, inputs used, result received, and expected result."
                      rows={6}
